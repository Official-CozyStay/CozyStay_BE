...
@NoArgsConstructor
@AllArgsConstructor
public class AccommodationMainResponseDTO {
    ...
    public static AccommodationMainResponseDTO fromEntity(Accommodation entity) {
        ...
        return new AccommodationMainResponseDTO(
                entity.getId(),
                entity.getTitle(),
                imageUrl,
